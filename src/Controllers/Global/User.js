...
export const dashboardData = async (req, res) => {
  try {
    ...
    const tasks = {
      ...
      Service:fetchDocs(Service),
      Product:fetchDocs(Product,{populate:["BrandId","TechnicalSpecs","Application"]}),
      Client:fetchDocs(Client),
      ProductBrand:fetchDocs(ProductBrand,{populate:["products"]}),
      Project:fetchDocs(Project),
